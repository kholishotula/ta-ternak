            ...
            <div class="modal-body">
                ...
                <form method="post" id="tambah_data_form">
                    ...
                    <div class="form-group">
                        <label class="control-label">Nama Peternakan</label>
                        <div class="form-line col-md-8">
                            <input type="text" name="nama_peternakan" id="nama_peternakan" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
...
@push('script2')
{{ $dataTable->scripts() }}
<script src="{{ asset('/js/data/datapeternakan.js') }}"></script>
@endpush